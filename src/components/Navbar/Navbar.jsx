    ...
    return (
        ...
        Reciped
                    ...
                    {/* <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto  lg:items-center lg:w-auto lg:space-x-6">
                        <li>
                            <Link to="https://github.com/mayurjadhav2002/reciped" className="text-sm text-gray-400 hover:text-gray-500" target='_blank'>
                                Github (code)
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to="https://recipe-website-backend-s4xz.onrender.com" className="text-sm text-gray-400 hover:text-gray-500" target='_blank'>
                                Backend (API hosted)
                            </Link>
                        </li>
                        <li className="text-gray-300">
                        ...
                        <li>
                            <Link to="https://reciped.vercel.app/" className="text-sm text-gray-400 hover:text-gray-500" target='_blank'>
                                Frontend (Vercel URL)
                            </Link>
                        </li>
                        ...
                        {loggedin ?
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    ...
                                    <DropdownMenuItem><Link to="/dashboard/write/new">Write new Recipe</Link></DropdownMenuItem>
                                    <DropdownMenuItem className="bg-red-500 text-white hover:bg-red-600" onClick={handleLogout}>Logout</DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>

                            :
                            <>
                                <Link to={'/login'} className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-red-50
                                border-orange-500 border-2
                                hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
                                >Sign In</Link>
                                <Link to={'/register'} className="hidden lg:inline-block py-2 px-6 bg-orange-500 hover:bg-orange-600 text-sm text-white font-bold rounded-xl transition duration-200"
                                >Sign up</Link>
                            </>
                        }
                    </div>
                    <div className="lg:hidden  right-0">
                        <Menubar>
                            <MenubarMenu>
                                ...
                                <MenubarTrigger className=" flex items-center text-blue-600 p-3" onClick={toggleMenu}>
                                ...
                                <MenubarContent>
                                    ...
                                    <MenubarItem>
                                        <Link to={"/login"} className='w-full '>
                                            <Button variant="secondary" className="w-full px-auto">Login</Button>
                                        </Link>
                                    </MenubarItem>

                                    <MenubarItem>
                                        <Link to={"/register"} className='w-full '>
                                            <Button className="w-full px-auto">Register</Button>
                                        </Link>
                                    </MenubarItem>
                                </MenubarContent>
                            </MenubarMenu>
